from classes.products import Electronics, Clothing, Сhemicals
...
washing_powder = Сhemicals(name='Tide Extra', price=600, type='Стиральный порошок')
...
cart = ShoppingCart(user=customer, registrator=admin)
